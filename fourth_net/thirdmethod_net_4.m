...
autoenc1 = train(autoenc1,my_pattern,my_pattern);
...
finalSoftmax.trainParam.epochs = 100;


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

finalSoftmax = train(finalSoftmax,feat2,target);
...
% Use all of the data for training
finalNetwork.divideFcn = 'dividerand';
...
finalNetwork.trainParam.epochs = 20;
